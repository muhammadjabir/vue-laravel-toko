...
<tbody>
<tr><th class="column text-xs-left">Order ID</th><td>{{
payment.order_id }}</td></tr>
<tr><th class="column text-xs-left">Invoice Number</th><td>{{
payment.invoice_number }}</td></tr>
<tr><th class="column text-xs-left">Total Bill</th><td>Rp. {{
payment.total_bill.toLocaleString('id-ID') }}</td></tr>
</tbody>
</table>
</v-container>
</v-card>
